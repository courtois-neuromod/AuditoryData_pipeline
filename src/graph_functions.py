...
if __name__ == "__main__":
    ...
    def plot_boxplot_pta(path, df, ear, display=False):
        ...
        fig.add_trace(go.Violin(
            x=new_df["Frequency (Hz)"][new_df["Protocol condition"] == "Baseline"],
        ...
        fig.add_trace(go.Violin(
            x=new_df["Frequency (Hz)"][new_df["Protocol condition"] == "Prescan"],
        ...
        fig.add_trace(go.Violin(
            x=new_df["Frequency (Hz)"][new_df["Protocol condition"] == "Postscan"],
        ...
        fig.add_trace(go.Violin(
            x=new_df["Frequency (Hz)"][new_df["Protocol condition"] == "48h+ Postscan"],
